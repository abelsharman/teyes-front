<template>
  <div v-if="!isError">
    ...
    <div class="flex" :class="isAllProducts ? 'flex-row mt-6 space-x-10' : 'flex-col'">
      <div v-if="isAllProducts" class="flex min-w-[200px] max-w-[200px] flex-col space-y-3">
        <button
          type="button"
          v-for="category in categories"
          :key="category.slug"
          class="text-lg text-left duration-200"
          :class=" selectedCategory.slug === category.slug ? 'font-bold' : 'hover:font-semibold'"
