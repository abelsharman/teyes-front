<template>
  <div class="">
    ...
    >
      <div
        class="flex justify-between items-center w-[630px] text-sm text-gray-1 text-opacity-70"
      >
        <div class="flex space-x-2">
          ...
          >
            <path
              d="M5.00008 16.6667H15.0001C15.4584 16.6667 15.8334 17.0417 15.8334 17.5001C15.8334 17.9584 15.4584 18.3334 15.0001 18.3334H5.00008C4.54175 18.3334 4.16675 17.9584 4.16675 17.5001C4.16675 17.0417 4.54175 16.6667 5.00008 16.6667ZM10.0001 5.83341C9.08341 5.83341 8.33341 6.58341 8.33341 7.50008C8.33341 8.41675 9.08341 9.16675 10.0001 9.16675C10.9167 9.16675 11.6667 8.41675 11.6667 7.50008C11.6667 6.58341 10.9167 5.83341 10.0001 5.83341ZM10.0001 1.66675C12.7251 1.66675 15.8334 3.71675 15.8334 7.62508C15.8334 10.1084 14.0584 12.7251 10.5084 15.4501C10.2084 15.6834 9.79175 15.6834 9.49175 15.4501C5.94175 12.7167 4.16675 10.1084 4.16675 7.62508C4.16675 3.71675 7.27508 1.66675 10.0001 1.66675Z"
              fill="#333333"
              fill-opacity="0.7"
            />
          </svg>
          <div>
            <p>Наш адрес:</p>
            <p class="text-medium mt-1">г. Алматы, ул. Тургут озала 260/1</p>
          </div>
        </div>
        <hr class="bg-gray-1 w-px h-[50px] bg-opacity-10" />
        <div class="flex space-x-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
          ...
          >
            <path
              d="M10 1.25C5.16797 1.25 1.25 5.16797 1.25 10C1.25 14.832 5.16797 18.75 10 18.75C14.832 18.75 18.75 14.832 18.75 10C18.75 5.16797 14.832 1.25 10 1.25ZM13.4473 12.6895L12.8887 13.4512C12.8765 13.4678 12.8612 13.4818 12.8436 13.4924C12.826 13.5031 12.8065 13.5102 12.7862 13.5132C12.7659 13.5163 12.7451 13.5154 12.7252 13.5104C12.7052 13.5055 12.6864 13.4966 12.6699 13.4844L9.43945 11.1289C9.41933 11.1145 9.40297 11.0954 9.39175 11.0733C9.38054 11.0512 9.37479 11.0267 9.375 11.002V5.625C9.375 5.53906 9.44531 5.46875 9.53125 5.46875H10.4707C10.5566 5.46875 10.627 5.53906 10.627 5.625V10.459L13.4121 12.4727C13.4824 12.5215 13.498 12.6191 13.4473 12.6895Z"
              fill="#333333"
              fill-opacity="0.7"
            />
          </svg>
          <div>
            <p>График работы:</p>
            <p class="text-medium mt-1">понедельник - суббота, с 10:00-20:00</p>
          </div>
        </div>
      </div>
      <div class="flex space-x-2">
    ...
    <div class="flex items-center justify-between py-4 w-full">
      ...
      <button
        type="button"
        class="py-1 px-2 rounded text-base font-semibold text-white bg-red-1 leading-8 hover:bg-red-2 duration-200"
      >
        Написать в WhatsApp
      </button>
    </div>
